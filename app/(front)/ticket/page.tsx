            ...
            <div className="">
                <div className="h-full py-8 my-8 w-full flex justify-center items-center">
                    <div className="h-full w-2/3 md:w-2/4 p-8 rounded-lg border border-red-500">
                        <p className="font-bold text-xl text-center py-2">Log a request</p>
                        <div className="flex flex-col mt-6 gap-4">
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <p className="font-bold text-sm col-span-1">Full Name</p>
                                <input className="bg-gray-100 py-2 px-4 rounded-lg w-full outline-none border-none col-span-3" />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <p className="font-bold text-sm col-span-1">Company</p>
                                <input className="bg-gray-100 py-2 px-4 rounded-lg w-full outline-none border-none col-span-3" />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-4  gap-4">
                                <p className="font-bold text-sm col-span-1">Email Address</p>
                                <input className="bg-gray-100 py-2 px-4 rounded-lg w-full outline-none border-none col-span-3" />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-4  gap-4">
                                <p className="font-bold text-sm col-span-1">Target Group</p>
                                <input className="bg-gray-100 py-2 px-4 rounded-lg w-full outline-none border-none col-span-3" />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-4  gap-4">
                                <p className="font-bold text-sm col-span-1">Priority</p>
                                <input className="bg-gray-100 py-2 px-4 rounded-lg w-full outline-none border-none col-span-3" />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-4  gap-4">
